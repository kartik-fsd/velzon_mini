...
const LanguageDropdown = () => {
  ...
  return (
    <React.Fragment>
            <style>{`
            .notify-item.language .dropdown-item.active,
            .notify-item.language .dropdown-item:active {
              color: unset; /* Reset color to inherit */
              text-decoration: unset; /* Reset text decoration to inherit */
              background-color: unset; /* Reset background color to inherit */
            }
            .btn.focus{
                outline:unset;
            }
